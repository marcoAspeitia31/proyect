    ...
    (function(t, e) {
      ...
      return function() {
        ...
        return function() {
            ...
            return G(t3, [{ key: "setValue", value: function(t4) {
              ...
              return [this.minRange, this.maxRange].forEach(function(a2, s2) {
                ...
                while (n2.isPos(f2) && d2(f2, p2)) {
                  var m3 = n2.getValidPos(f2 + o2, h2), v2 = m3.pos;
          ...
          var mt = { None: 0, Drag: 2, Focus: 4 }, vt = 4, yt = (0, o.defineComponent)({ name: "VueSlider", components: { VueSliderDot: m2, VueSliderMark: k }, emits: ["change", "drag-start", "dragging", "drag-end", "error", "update:modelValue"], data: function() {
          ...
          var gt = bt;
          gt.VueSliderMark = k, gt.VueSliderDot = m2;
          var kt = gt, St = kt;
        }(), i = i["default"], i;
      }();
    });
