      ...
      <div class="row">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" id="store" viewBox="130 0 1230 930">
                <defs>
                  ...
                  <g id="cat">
                    ...
                    <path fill="#FFF" stroke="#f4a9bc" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <circle fill="#FFF" stroke="#f4a9bc" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="col-sm-8 m-auto">
          <div class="coming-soon-content">
            <div>
              <h1>{{ useRuntimeConfig().public.const.Wearecomingsoon }}</h1>
              <p>
                {{ useRuntimeConfig().public.const.ComingDescription }}
              </p>
              <form>
                <input class="form-control" placeholder="enter your email address" />
                <nuxt-link to="/home/fashion_demo" class="btn btn-solid-default mt-4">{{
                  useRuntimeConfig().public.const.NotifyMe
                }}</nuxt-link>
              </form>
            </div>
          </div>
