    ...
    <div class="card-body">
      ...
      <div v-if="selectedUser" class="edit-form">
        ...
        <form @submit.prevent="updateUserRole">
          ...
          <div v-if="selectedUser.rol" class="permissions">
            <h5>Permisos del Rol:</h5>
            <ul>
              <li v-for="permission in rolePermissions[selectedUser.rol]" :key="permission">{{ permission }}</li>
            </ul>
          </div>
...
export default {
  data() {
    return {
      ...
      rolePermissions: {
        'Administrador': ['Crear usuarios', 'Actualizar usuarios', 'Suspender usuarios', 'Listar usuarios'],
        'Sistemas': ['Crear usuarios', 'Actualizar usuarios', 'Suspender usuarios', 'Listar usuarios'],
        'Sucursal': ['Listar usuarios']
      }
    };
  },
  created() {
